...
const char *v4l2_ctrl_get_name(u32 id)
{
	...
	case V4L2_CID_MIRROR_ZGB:		return "Mirror setting";
	case V4L2_CID_FLIP_ZGB:			return "Flip setting";
	case V4L2_SPECIAL_EFFECTS_ZGB:  return "Special effects";
	case V4L2_CID_WHITE_BALANCE_ZGB:	return "White balance mode";
